...
class SpringappApplicationTests {
 ...
 //WorkoutTestCases
	 ...
	 Set_ s=new Set_(3L,1L,20L,"10kg","1 hour");
	 
	 Set_ setValue=new Set_(1L,1L,20L,"10kg","1 hour");


	 Set_ set=new Set_(2L,1L,2L,"10kg","1 hour");
	


	 List<Set_> setList=Arrays.asList(s,set);
